...
#
# This file was copied from the master jenkins repository until the point
# we update to Jenkins 2.x and get this updated install script into the
# base image
#
...
function resolveDependencies() {
	...
	# EDIT: I replaces a sed command with [tr -d $'\r'].
